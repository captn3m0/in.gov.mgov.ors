...
class BookAppointment$CallList
  extends AsyncTask
{
  private ProgressDialog dlog;
  
  private BookAppointment$CallList(BookAppointment paramBookAppointment) {}
  ...
  protected String doInBackground(String... paramVarArgs)
  {
    ...
    BookAppointment.access$202((BookAppointment)localObject1, (String)localObject2);
    SoapObject localSoapObject = new org/ksoap2/serialization/SoapObject;
    localObject2 = BookAppointment.access$200(this$0);
    ...
    catch (Exception localException)
    {
      ...
      {
        localObject1 = this$0;
        localObject2 = new in/gov/mgov/ors/BookAppointment$CallList$1;
        ((BookAppointment.CallList.1)localObject2).<init>(this);
        ((BookAppointment)localObject1).runOnUiThread((Runnable)localObject2);
      }
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool1)
        {
          ...
          localObject3 = ((BookAppointment)localObject1).getResources();
          i2 = 2131034309;
          ...
          localObject1 = this$0;
          localObject4 = localObject1;
          localObject4 = ((BookAppointment)localObject1).getApplicationContext();
          i6 = 2130903050;
          localObject1 = this;
          localObject1 = this$0;
          localObject1 = state;
        ...
        if (bool2)
        {
          ...
          if (j == i7)
          {
            ...
            localObject1 = this$0;
            localObject2 = localObject1;
            localObject3 = new in/gov/mgov/ors/BookAppointment$CallList$2;
            localObject1 = localObject3;
            ((BookAppointment.CallList.2)localObject3).<init>(this);
            ((BookAppointment)localObject2).runOnUiThread((Runnable)localObject3);
          }
          localObject1 = this;
          localObject1 = this$0;
          localObject2 = localObject1;
        ...
        if (bool3)
        {
          ...
          if (k == i7)
          {
            ...
            localObject1 = this$0;
            localObject2 = localObject1;
            localObject3 = new in/gov/mgov/ors/BookAppointment$CallList$3;
            localObject1 = localObject3;
            ((BookAppointment.CallList.3)localObject3).<init>(this);
            ((BookAppointment)localObject2).runOnUiThread((Runnable)localObject3);
          }
          localObject1 = this;
          localObject1 = this$0;
        ...
        if (bool4)
        {
          ...
          localObject1 = this$0;
          localObject2 = localObject1;
          bool7 = ((BookAppointment)localObject1).isConnected();
          if (bool7)
          {
            localObject2 = new in/gov/mgov/ors/BookAppointment$CallListagain;
            localObject1 = this;
            localObject1 = this$0;
            localObject3 = localObject1;
            i2 = 0;
            localObject4 = null;
            ((BookAppointment.CallListagain)localObject2).<init>((BookAppointment)localObject1, null);
            i7 = 1;
            ...
            localObject1[0] = str3;
            ((BookAppointment.CallListagain)localObject2).execute((Object[])localObject1);
          }
        }
        localObject1 = this;
        localObject1 = this$0;
        ...
        if (bool7)
        {
          ...
          if (bool7)
          {
            ...
            localObject3 = EnterAadhaar.class;
            localObject1 = localObject2;
      ...
      localObject1 = spacialitymessage;
      localObject3 = localObject1;
      BookAppointment.access$500((BookAppointment)localObject2, (String)localObject1);
    }
  }
  ...
  protected void onPreExecute()
  {
    ...
    localProgressDialog = dlog;
    localObject = this$0.getResources().getString(2131034206);
...
/* Location:              /home/nemo/projects/personal/ors/ORS-enjarify.jar!/in/gov/mgov/ors/BookAppointment$CallList.class
