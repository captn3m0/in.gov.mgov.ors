  ...
  extends Activity
{
  ...
  private void intitalizeViews()
  {
    ...
    ShowUIDAIDataNonNumber.1 local1 = new in/gov/mgov/ors/ShowUIDAIDataNonNumber$1;
    local1.<init>(this);
  ...
  private void showDialogonclick(String paramString)
  {
    ...
    ShowUIDAIDataNonNumber.4 local4 = new in/gov/mgov/ors/ShowUIDAIDataNonNumber$4;
    local4.<init>(this);
  ...
  private void updateView()
  {
    ...
    int i = Integer.parseInt(pref.getString("state_code", "0"));
    statecode = i;
    i = Integer.parseInt(pref.getString("dept_code", "0"));
    departmentcode = i;
    ...
    localObject2 = (String)localObject3;
    ((TextView)localObject1).setText((CharSequence)localObject2);
    localObject1 = getIntent().getStringArrayExtra("uid_data");
    uidData = ((String[])localObject1);
    localObject1 = pref.getString("aadhaar_no", "");
    ...
    ((TextView)localObject1).setText((CharSequence)localObject2);
    localObject1 = yes;
    localObject2 = new in/gov/mgov/ors/ShowUIDAIDataNonNumber$2;
    ((ShowUIDAIDataNonNumber.2)localObject2).<init>(this);
    ((Button)localObject1).setOnClickListener((View.OnClickListener)localObject2);
    localObject1 = no;
    localObject2 = new in/gov/mgov/ors/ShowUIDAIDataNonNumber$3;
    ((ShowUIDAIDataNonNumber.3)localObject2).<init>(this);
...
/* Location:              /home/nemo/projects/personal/ors/ORS-enjarify.jar!/in/gov/mgov/ors/ShowUIDAIDataNonNumber.class
