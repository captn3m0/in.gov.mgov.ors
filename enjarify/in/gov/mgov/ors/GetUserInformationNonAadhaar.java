...
public class GetUserInformationNonAadhaar
  extends Activity
{
  Button Submit;
  TextView aadhaar;
  ...
  public GetUserInformationNonAadhaar()
  {
  ...
  {
    int i = 2131296384;
    Object localObject = (Spinner)findViewById(2131296386);
    ...
    localObject = (TextView)findViewById(i);
    mobilenumbertext = ((TextView)localObject);
    ...
    GetUserInformationNonAadhaar.2 local2 = new in/gov/mgov/ors/GetUserInformationNonAadhaar$2;
    local2.<init>(this);
  ...
  private void showDialogonclick(String paramString)
  {
    ...
    GetUserInformationNonAadhaar.3 local3 = new in/gov/mgov/ors/GetUserInformationNonAadhaar$3;
    local3.<init>(this);
  ...
  private void updateView()
  {
    ...
    ((Spinner)localObject1).setAdapter((SpinnerAdapter)localObject2);
    localObject1 = Submit;
    localObject2 = new in/gov/mgov/ors/GetUserInformationNonAadhaar$1;
    ((GetUserInformationNonAadhaar.1)localObject2).<init>(this);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (bool2)
    {
      ...
      mobile.setText(str4);
      localObject1 = mobilenumbertext;
      localObject2 = new java/lang/StringBuilder;
      ((StringBuilder)localObject2).<init>();
      localObject3 = mobilenumbertext.getText();
    ...
    if (bool2)
    {
      ...
      i = str3.indexOf(" ");
      int k = str3.length();
      localObject2 = str3.substring(i, k);
      ((EditText)localObject1).setText((CharSequence)localObject2);
      mobile.setText(str4);
      localObject1 = name;
      localObject2 = new java/lang/StringBuilder;
...
/* Location:              /home/nemo/projects/personal/ors/ORS-enjarify.jar!/in/gov/mgov/ors/GetUserInformationNonAadhaar.class
