...
public class ShowUIDAIDataNonNumber
  extends Activity
{
  ...
  private void updateView()
  {
    ...
    uidData = getIntent().getStringArrayExtra("uid_data");
    aadhaarno = pref.getString("aadhaar_no", "");
    name.setText(getResources().getString(2131034242) + ": " + uidData[0]);
    ...
    yes.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        if (isConnected()) {
          new ShowUIDAIDataNonNumber.CallList(ShowUIDAIDataNonNumber.this, null).execute(new String[] { "fixAppointment" });
        }
      }
    });
    ...
    extends AsyncTask<String, String, String>
  {
    ...
    {
      ShowUIDAIDataNonNumber.access$102(ShowUIDAIDataNonNumber.this, paramVarArgs[0]);
      ...
      if (METHOD.equals("fixAppointment"))
      {
        ...
        String str5 = j - i + "";
        ((SoapObject)localObject).addProperty(addProperties("flagtp", 2, Integer.class));
      ...
      catch (Exception paramVarArgs)
      {
        for (;;)
        {
          runOnUiThread(new Runnable()
          {
            public void run()
            {
              ShowUIDAIDataNonNumber.this.showDialogonclick(getResources().getString(2131034199));
            }
          });
        }
      }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          else
          {
            ...
            if (finalresp.equals("{}")) {
              ShowUIDAIDataNonNumber.this.showDialogonclick(getResources().getString(2131034334));
            }
            ...
            runOnUiThread(new Runnable()
            {
              public void run()
              {
                try
                {
                  ShowUIDAIDataNonNumber.this.showDialogonclick(paramString.getString("error_string"));
                  return;
                }
        ...
        catch (JSONException paramString)
        {
          runOnUiThread(new Runnable()
          {
            public void run()
            {
              ShowUIDAIDataNonNumber.this.showDialogonclick(getResources().getString(2131034342));
            }
          });
          return;
        }
    ...
    {
      super.onPreExecute();
      dlog = new ProgressDialog(ShowUIDAIDataNonNumber.this);
...
/* Location:              /home/nemo/projects/personal/ors/ORS-dex2jar.jar!/in/gov/mgov/ors/ShowUIDAIDataNonNumber.class
