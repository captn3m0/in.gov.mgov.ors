  ...
  extends Activity
{
  ...
  private void intitalizeViews()
  {
    ...
    mobilenumbertext = ((TextView)findViewById(2131296384));
  ...
  private void updateView()
  {
    ...
    Submit.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        ...
        GetUserInformationNonAadhaar.this.showDialogonclick((String)localObject);
      }
    });
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    editor = pref.edit();
    appointmentdate.setText(getResources().getString(2131034133) + ": " + pref.getString("date_name", ""));
    ...
    if (location.equals("noaadhaar"))
    {
      ...
      mobilenumbertext.setText(mobilenumbertext.getText() + (String)localObject);
...
/* Location:              /home/nemo/projects/personal/ors/ORS-dex2jar.jar!/in/gov/mgov/ors/GetUserInformationNonAadhaar.class
