  ...
  extends Activity
{
  ...
  private void intitalizeViews()
  {
    ...
    button_home.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        paramAnonymousView = new Intent(getApplicationContext(), ShowAppointment.class);
  ...
  private void updateView()
  {
    ...
    payment.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        paramAnonymousView = new Intent(ShowAppointment.this, payment.class);
        startActivity(paramAnonymousView);
      }
    });
    ...
    if (pref.getString("hid_data", "").length() != 0)
    {
    ...
    extends AsyncTask<String, String, String>
  {
    ...
    {
      ShowAppointment.access$102(ShowAppointment.this, paramVarArgs[0]);
    ...
    protected void onPostExecute(String paramString)
    {
      ...
      try
      {
        if (ShowAppointment.this.PayNow(finalresp)) {
    ...
    {
      super.onPreExecute();
      dlog = new ProgressDialog(ShowAppointment.this);
...
/* Location:              /home/nemo/projects/personal/ors/ORS-dex2jar.jar!/in/gov/mgov/ors/ShowAppointment.class
