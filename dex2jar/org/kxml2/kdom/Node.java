...
public class Node
{
  ...
  public void addChild(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    while ((paramObject instanceof String))
    {
      ...
      types.insert(paramInt1, (char)paramInt2);
      return;
    }
  ...
  public void removeChild(int paramInt)
  {
    ...
    while (paramInt < i)
    {
      types.setCharAt(paramInt, types.charAt(paramInt + 1));
      paramInt += 1;
    }
    types.setLength(i);
  }
    ...
    throws IOException
  {
    ...
    int k = getType(i);
    Object localObject = children.elementAt(i);
    switch (k)
    {
    case 3: 
    default: 
...
/* Location:              /home/nemo/projects/personal/ors/ORS-dex2jar.jar!/org/kxml2/kdom/Node.class
