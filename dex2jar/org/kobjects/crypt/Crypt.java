...
public class Crypt
{
  ...
  private static final int[] body(int[] paramArrayOfInt, int paramInt1, int paramInt2)
  {
    ...
    while (k < 25)
    {
      ...
      while (m < 32)
      {
        i = D_ENCRYPT(i, j, m, paramInt1, paramInt2, paramArrayOfInt);
        j = D_ENCRYPT(j, i, m + 2, paramInt1, paramInt2, paramArrayOfInt);
        m += 4;
      }
      m = i;
      k += 1;
    ...
    PERM_OP((i >>> 1 | i << 31) & 0xFFFFFFFF, (j >>> 1 | j << 31) & 0xFFFFFFFF, 1, 1431655765, paramArrayOfInt);
    paramInt1 = paramArrayOfInt[0];
    PERM_OP(paramArrayOfInt[1], paramInt1, 8, 16711935, paramArrayOfInt);
    paramInt1 = paramArrayOfInt[0];
    PERM_OP(paramArrayOfInt[1], paramInt1, 2, 858993459, paramArrayOfInt);
    paramInt1 = paramArrayOfInt[0];
    PERM_OP(paramArrayOfInt[1], paramInt1, 16, 65535, paramArrayOfInt);
    paramInt1 = paramArrayOfInt[0];
    PERM_OP(paramArrayOfInt[1], paramInt1, 4, 252645135, paramArrayOfInt);
    paramInt1 = paramArrayOfInt[0];
  ...
  public static final String crypt(String paramString1, String paramString2)
  {
    ...
    {
      paramString1[i] = ((byte)(paramString2.charAt(i) << '\001'));
      i += 1;
    }
    paramString1 = body(des_set_key(paramString1), j, k << 4);
    paramString2 = new byte[9];
    intToFourBytes(paramString1[0], paramString2, 0);
    intToFourBytes(paramString1[1], paramString2, 4);
    paramString2[8] = 0;
    k = 2;
    int m = 0;
    j = 128;
    while (k < 13)
    {
      ...
      while (n < 6)
      {
        ...
        localStringBuffer.setCharAt(k, (char)cov_2char[i]);
        n += 1;
        m = i1;
      }
      k += 1;
  ...
  private static int[] des_set_key(byte[] paramArrayOfByte)
  {
    ...
    PERM_OP(j, i, 4, 252645135, paramArrayOfByte);
    i = paramArrayOfByte[0];
    j = HPERM_OP(paramArrayOfByte[1], -2, -859045888);
    PERM_OP(HPERM_OP(i, -2, -859045888), j, 1, 1431655765, paramArrayOfByte);
    i = paramArrayOfByte[0];
    PERM_OP(paramArrayOfByte[1], i, 8, 16711935, paramArrayOfByte);
    i = paramArrayOfByte[0];
    PERM_OP(paramArrayOfByte[1], i, 1, 1431655765, paramArrayOfByte);
    ...
    if (i < 16)
    {
      ...
      for (k = k >>> 2 | k << 26;; k = k >>> 1 | k << 27)
      {
        ...
        int n = j + 1;
        arrayOfInt[j] = ((i2 << 16 | 0xFFFF & i1) & 0xFFFFFFFF);
        i1 = i1 >>> 16 | 0xFFFF0000 & i2;
        j = n + 1;
        arrayOfInt[n] = ((i1 << 4 | i1 >>> 28) & 0xFFFFFFFF);
        i += 1;
        break;
        m = m >>> 1 | m << 27;
      }
  ...
  {
    return crypt(Integer.toHexString(new Random().nextInt() & 0xFFFF), paramString);
  }
    ...
    throws IOException
  {
    ...
    for (;;)
    {
      ...
      if (i < 32)
      {
        System.out.println(generate(paramArrayOfString.toString()));
        return;
      }
      paramArrayOfString.append((char)i);
    }
  }
  ...
  public static final boolean match(String paramString1, String paramString2)
  {
    ...
    return paramString2.equals(crypt(paramString2.substring(0, 2), paramString1));
  }
}


/* Location:              /home/nemo/projects/personal/ors/ORS-dex2jar.jar!/org/kobjects/crypt/Crypt.class
