...
public abstract class PimItem
{
  ...
  {
    Vector localVector = (Vector)fields.get(paramString);
  ...
  {
    paramString = (Vector)fields.get(paramString);
    if (paramString == null) {
      return 0;
    }
...
/* Location:              /home/nemo/projects/personal/ors/ORS-dex2jar.jar!/org/kobjects/pim/PimItem.class
