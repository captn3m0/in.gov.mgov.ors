...
public abstract class Transport
{
  ...
  protected byte[] createRequestData(SoapEnvelope paramSoapEnvelope, String paramString)
    throws IOException
  {
    ByteArrayOutputStream localByteArrayOutputStream = new ByteArrayOutputStream(bufferLength);
    localByteArrayOutputStream.write(xmlVersionTag.getBytes());
...
/* Location:              /home/nemo/projects/personal/ors/ORS-dex2jar.jar!/org/ksoap2/transport/Transport.class
