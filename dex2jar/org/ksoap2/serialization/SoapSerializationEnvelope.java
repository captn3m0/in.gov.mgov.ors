  ...
  extends SoapEnvelope
{
    ...
    throws IOException
  {
    ...
    {
      writeVectorBody(paramXmlSerializer, (Vector)paramObject1, elementType);
      return;
    }
  ...
  public void addMapping(String paramString1, String paramString2, Class paramClass, Marshal paramMarshal)
  {
    ...
    for (Object localObject = paramClass;; localObject = paramMarshal)
    {
      ...
      classToQName.put(paramClass.getName(), new Object[] { paramString1, paramString2, null, paramMarshal });
      return;
    }
  }
  ...
  {
    qNameToClass.put(new SoapPrimitive(namespace, name, null), paramSoapObject);
  }
  ...
  public Object[] getInfo(Object paramObject1, Object paramObject2)
  {
    ...
    do
    {
      ...
      paramObject2 = (Object[])classToQName.get(((Class)localObject).getName());
    ...
    throws IOException, XmlPullParserException
  {
    ...
    if ((paramXmlPullParser.getEventType() == 2) && (paramXmlPullParser.getNamespace().equals(env)) && (paramXmlPullParser.getName().equals("Fault"))) {
      if (version < 120)
      {
        localObject1 = new SoapFault(version);
    ...
    {
      return;
      localObject1 = new SoapFault12(version);
      break;
      while (paramXmlPullParser.getEventType() == 2)
      {
        localObject1 = paramXmlPullParser.getAttributeValue(enc, "root");
        ...
        if (("1".equals(localObject1)) || (bodyIn == null)) {
          bodyIn = localObject2;
        }
        paramXmlPullParser.nextTag();
      }
    ...
    throws IOException, XmlPullParserException
  {
    ...
    if (str1 != null)
    {
      ...
      paramString2 = idMap.get(paramPropertyInfo);
      ...
      else
      {
        ...
        next = ((FwdRef)paramString2);
        obj = paramObject;
        index = paramInt;
        idMap.put(paramPropertyInfo, paramString1);
        paramString1 = null;
      }
      paramXmlPullParser.nextTag();
    ...
    do
    {
      paramXmlPullParser.require(3, null, str2);
      return paramObject;
      str1 = paramXmlPullParser.getAttributeValue(xsi, "nil");
      str3 = paramXmlPullParser.getAttributeValue(null, "id");
      paramObject = str1;
      if (str1 == null) {
        paramObject = paramXmlPullParser.getAttributeValue(xsi, "null");
      }
    ...
    if ((paramObject instanceof FwdRef))
    {
      ...
      do
      {
        ...
        ((KvmSerializable)obj).setProperty(index, paramString1);
        paramString2 = next;
    ...
    while (paramObject == null) {
      for (;;)
      {
        idMap.put(str3, paramString1);
        paramObject = paramString1;
        break;
        String str4 = paramXmlPullParser.getAttributeValue(xsi, "type");
        if (str4 != null)
        {
        ...
        for (;;)
        {
          ...
          if (paramString2 == null)
          {
            ...
            if (paramString1 == null) {
              if (paramXmlPullParser.getAttributeValue(enc, "arrayType") != null)
              {
                paramObject = enc;
                str1 = "Array";
              }
              ...
              {
                paramString1 = getInfo(type, null);
        ...
        ((Vector)obj).setElementAt(paramString1, index);
      }
    }
  ...
  public Object readInstance(XmlPullParser paramXmlPullParser, String paramString1, String paramString2, PropertyInfo paramPropertyInfo)
    throws IOException, XmlPullParserException
  {
    Object localObject = qNameToClass.get(new SoapPrimitive(paramString1, paramString2, null));
    if (localObject == null) {
      return null;
    }
    ...
    {
      readVector(paramXmlPullParser, (Vector)paramString1, elementType);
      return paramString1;
    }
    ...
    throws IOException, XmlPullParserException
  {
    while (paramXmlPullParser.nextTag() != 3)
    {
      ...
      if ((!implicitTypes) || (!(paramKvmSerializable instanceof SoapObject)))
      {
        ...
        while ((i < m) && (j == 0))
        {
          ...
          paramKvmSerializable.getPropertyInfo(i, properties, localPropertyInfo);
          int k;
          if ((!str.equals(name)) || (namespace != null))
          {
            k = j;
            if (str.equals(name))
            {
              k = j;
              if (!paramXmlPullParser.getNamespace().equals(namespace)) {}
            }
          }
          else
          {
    ...
    throws IOException, XmlPullParserException
  {
    ...
    int k = 1;
    String str2 = paramXmlPullParser.getAttributeValue(enc, "arrayType");
    int j = k;
    Object localObject3;
    if (str2 != null)
    {
    ...
    for (localObject1 = "";; localObject1 = str2.substring(0, i))
    {
      ...
      paramXmlPullParser.nextTag();
      m = getIndex(paramXmlPullParser.getAttributeValue(enc, "offset"), 0, 0);
      while (paramXmlPullParser.getEventType() != 3)
      {
        m = getIndex(paramXmlPullParser.getAttributeValue(enc, "position"), 0, m);
        k = i;
        if (j != 0)
        {
          k = i;
    ...
    throws IOException
  {
    ...
    if (bodyOut != null)
    {
      ...
      arrayOfObject = getInfo(null, bodyOut);
      if (!dotNet) {
        break label171;
      }
      str = "";
      ...
      if (addAdornments)
      {
        ...
        paramXmlSerializer.attribute(enc, "root", "1");
      }
      writeElement(paramXmlSerializer, bodyOut, null, arrayOfObject[3]);
      if (!dotNet) {
        break label191;
      }
    }
    ...
    throws IOException
  {
    ...
    while (i < j)
    {
      ...
      else
      {
        ...
        label307:
        for (localObject2 = namespace;; localObject2 = (String)localObject2[0])
        {
          ...
          if (!implicitTypes)
          {
            ...
            paramXmlSerializer.attribute(xsi, "type", str2 + ":" + str1);
          }
    ...
    throws IOException
  {
    ...
    if ((multiRef) || (arrayOfObject[2] != null))
    {
      int j = multiRef.indexOf(paramObject);
      int i = j;
      if (j == -1)
      {
        i = multiRef.size();
        multiRef.addElement(paramObject);
      }
      if (arrayOfObject[2] == null) {}
    ...
    if ((!implicitTypes) || (paramObject.getClass() != type))
    {
      String str = paramXmlSerializer.getPrefix((String)arrayOfObject[0], true);
      paramXmlSerializer.attribute(xsi, "type", str + ":" + arrayOfObject[1]);
    }
    ...
    throws IOException
  {
    ...
    if (paramPropertyInfo == null)
    {
      ...
      localObject3 = getInfo(type, null);
      if (implicitTypes) {
        break label210;
      }
      paramXmlSerializer.attribute(enc, "arrayType", paramXmlSerializer.getPrefix((String)localObject3[0], false) + ":" + localObject3[1] + "[" + m + "]");
    ...
    for (int i = 1;; i = j)
    {
      ...
      if (i != 0)
      {
        paramXmlSerializer.attribute(enc, "position", "[" + k + "]");
        j = 0;
      }
...
/* Location:              /home/nemo/projects/personal/ors/ORS-dex2jar.jar!/org/ksoap2/serialization/SoapSerializationEnvelope.class
