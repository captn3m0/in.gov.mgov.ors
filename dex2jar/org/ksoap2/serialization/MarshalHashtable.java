  ...
  implements Marshal
{
    ...
    throws IOException, XmlPullParserException
  {
    ...
    while (paramXmlPullParser.nextTag() != 3)
    {
      ...
      Object localObject = envelope.read(paramXmlPullParser, paramPropertyInfo, 0, null, null, PropertyInfo.OBJECT_TYPE);
      paramXmlPullParser.nextTag();
      if (localObject != null) {
        paramPropertyInfo.setProperty(0, localObject);
      }
      localObject = envelope.read(paramXmlPullParser, paramPropertyInfo, 1, null, null, PropertyInfo.OBJECT_TYPE);
      paramXmlPullParser.nextTag();
      if (localObject != null) {
    ...
    extends SoapObject
  {
    ...
    public void setProperty(int paramInt, Object paramObject)
    {
      ...
      {
        h.put(paramObject, localObject);
        return;
      }
      h.put(localObject, paramObject);
    }
  }
}


/* Location:              /home/nemo/projects/personal/ors/ORS-dex2jar.jar!/org/ksoap2/serialization/MarshalHashtable.class
