  ...
  implements Marshal
{
  ...
  {
    paramSoapSerializationEnvelope.addMapping(xsd, "int", PropertyInfo.INTEGER_CLASS, this);
    paramSoapSerializationEnvelope.addMapping(xsd, "long", PropertyInfo.LONG_CLASS, this);
    paramSoapSerializationEnvelope.addMapping(xsd, "string", PropertyInfo.STRING_CLASS, this);
    paramSoapSerializationEnvelope.addMapping(xsd, "boolean", PropertyInfo.BOOLEAN_CLASS, this);
  }
...
/* Location:              /home/nemo/projects/personal/ors/ORS-dex2jar.jar!/org/ksoap2/serialization/DM.class
